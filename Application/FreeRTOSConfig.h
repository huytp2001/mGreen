...
//#include "mmt_freertos_ext.h"

#define CPU_SYS_CLOCK   120000000
/*-----------------------------------------------------------
 ...
 *----------------------------------------------------------*/
#define configUSETIMESLCICING               1
#define configUSE_PREEMPTION                1
#define configUSE_IDLE_HOOK                 0
#define configUSE_TICK_HOOK                 0
#define configCPU_CLOCK_HZ                  ( ( unsigned long ) CPU_SYS_CLOCK )
...
#define configTIMER_TASK_STACK_DEPTH	( configMINIMAL_STACK_SIZE * 4 ) //( configMINIMAL_STACK_SIZE * 2 )
...
#define traceTASK_SWITCHED_IN()     //(lastTaskID = (int)pxCurrentTCB->pxTaskTag )
