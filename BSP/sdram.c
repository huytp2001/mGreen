...
* @date 10 Nov 2020
* @version: 2.0.0
* @brief This file contains function to init external EPI SDRAM.
* @detail
...
* @def EPI_PORTA_PINS (GPIO_PIN_7 | GPIO_PIN_6)
* @def EPI_PORTB_PINS (GPIO_PIN_3)
* @def EPI_PORTC_PINS (GPIO_PIN_7 | GPIO_PIN_6 | GPIO_PIN_5 | GPIO_PIN_4)
* @def EPI_PORTG_PINS (GPIO_PIN_1 | GPIO_PIN_0)
* @def EPI_PORTH_PINS (GPIO_PIN_3 | GPIO_PIN_2 | GPIO_PIN_1 | GPIO_PIN_0)
* @def EPI_PORTK_PINS (GPIO_PIN_5)
* @def EPI_PORTL_PINS (GPIO_PIN_3 | GPIO_PIN_2 | GPIO_PIN_1 | GPIO_PIN_0)
* @def EPI_PORTM_PINS (GPIO_PIN_3 | GPIO_PIN_2 | GPIO_PIN_1 | GPIO_PIN_0)
* @def EPI_PORTP_PINS (GPIO_PIN_3 | GPIO_PIN_2)
*
*/
...
/*!
*	@def SDRAM_START_ADDRESS 0x00000000
*	The starting address for SDRAM
*/
/*!
*	@def SDRAM_END_ADDRESS   0x01FFFFFF 
*	The ending address for the 64MB SDRAM chip (32Meg x 16bits) on
...
/*!
* @struct tSDRAMFreqMapping
* A struct used to determine the EPI clock frequency band in use.
*/
...
/*!
 * @fn v_sdram_init(uint32_t ui32SysClock)
 * @brief This function used to init external EPI SDRAM
 * @param[in] ui32SysClock Clock of system
 * @retrun None
 */
void v_sdram_init(uint32_t ui32SysClock)
{
	...
	// Update based upon the EPI pin assignment on your target part.
	//
	...
	// implementation.
	// Update this section based upon the EPI pin assignment on your
	// target part.
	//
